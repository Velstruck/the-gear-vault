        ...
        <div className="flex flex-wrap gap-2" ref={parent}>
          ...
          {product.flipkartUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 text-sm font-medium border rounded-lg focus:z-10 focus:ring-2 focus:outline-none bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white border-blue-600 hover:border-blue-700"
            >
